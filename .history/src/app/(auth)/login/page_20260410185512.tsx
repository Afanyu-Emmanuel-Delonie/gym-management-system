  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative">
      ...
      <div className="relative z-10 w-full max-w-sm" style={{ padding: "0 1rem" }}>
        ...
        >
          <h1 className="text-2xl mb-1 text-center" style={{ color: "var(--color-overlay-text)" }}>Welcome back</h1>
          <p className="mb-6" style={{ color: "var(--color-overlay-muted)", fontSize: "var(--text-sm)" }}>
