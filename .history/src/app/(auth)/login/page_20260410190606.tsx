      ...
      >
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Link href="#" className="block text-right px-2 hover: text-(" style={{ color: "var(--color-primary)", fontSize: "var(--text-sm)", hover: var(--color-overlay-muted) }}>Forgot Password?</Link>
