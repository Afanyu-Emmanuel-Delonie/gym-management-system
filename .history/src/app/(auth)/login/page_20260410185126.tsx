  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative">
      ...
      <div className="relative z-10 w-full max-w-sm" style={{ padding: "0 1rem" }}>
        ...
        >
          <h1 className="text-2xl font-bold mb-1" style={{ color: "#fff" }}>Welcome back</h1>
          <p className="mb-6 item-center" style={{ color: "rgba(255,255,255,0.5)", fontSize: "var(--text-sm)" }}>
            Sign in to your account
          </p>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block mb-1" style={{ fontSize: "var(--text-sm)", fontWeight: 500, color: "rgba(255,255,255,0.7)" }}>Email</label>
              <input name="email" type="email" required className="input" placeholder="you@example.com"
                style={{ backgroundColor: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.15)", color: "#fff" }}
              />
            </div>
            <div>
              <label className="block mb-1" style={{ fontSize: "var(--text-sm)", fontWeight: 500, color: "rgba(255,255,255,0.7)" }}>Password</label>
