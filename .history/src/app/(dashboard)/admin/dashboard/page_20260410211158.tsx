        ...
        {CARDS.map((card) => {
          ...
          return (
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: "var(--text-3xl)", fontWeight: 700, color: active ? "#fff" : "var(--color-text-primary)", lineHeight: 1, position: "relative", fontFamily: "var(--font-title)" }}>
                {card.value}
              </p>
